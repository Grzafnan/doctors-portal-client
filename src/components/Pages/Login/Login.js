...
const Login = () => {
  ...
  const { signInWithProvider, signInWithEmail, setLoading } = useContext(AuthContext);
  const { register, handleSubmit, reset, formState: { errors } } =
    useForm();

  const [loginUserEmail, setLoginUserEmail] = useState('')

  const [token] = JwtVerify(loginUserEmail);
            ...
            >
              ...
              <div className='mt-[18px]'>
                <input
                  type="submit"
                  value='Log in'
                  className='h-11 text-white btn-accent w-full border-[2px] pl-3 rounded-[10px] cursor-pointer'
                />
              </div>
            </form>
            ...
            <div className=''>
              ...
              <div className='mt-[25px]'>
                <button
                  ...
                  className='btn btn-accent text-base hover:text-white btn-outline w-full'>
